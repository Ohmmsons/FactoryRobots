...
public class RectangleFactory implements ShapeFactory {
     ...
     * @pre generator != null
     * @post A RectangleFactory instance is created with the specified generator.
     */
    public RectangleFactory(Random generator) {
        if (generator == null) {
     ...
     * @post The returned Rectangle has valid corner points.
     */
    @Override
